RSpec.describe Bunto::SeoTag::Drop do
  ...
  it "returns the version" do
    expect(subject.version).to eql(Bunto::SeoTag::VERSION)
  end
  ...
  context "name" do
    ...
    context "author" do
      ...
      context "twitter" do
        ...
        # See https://github.com/bunto/bunto-seo-tag/issues/202
  ...
  context "canonical url" do
    ...
    context "when canonical url is specified for a page" do
      let(:canonical_url) { "https://github.com/bunto/bunto-seo-tag/" }
